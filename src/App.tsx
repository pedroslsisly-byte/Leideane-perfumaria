              ...
              return (
                ...
                >
                  ...
                  <div className="pt-2.5 sm:pt-3 border-t border-white/10 flex items-center justify-between mt-1">
                    ...
                    <div 
                      className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#25D366]/20 border border-[#25D366]/50 text-[#25D366] hover:bg-[#25D366] hover:text-black flex items-center justify-center transition-all duration-300"
                    >
                      <WhatsAppIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 transition-transform group-hover:scale-110" />
                    </div>
                  </div>
                </div>
              );
              ...
              {filteredProducts.map((p) => (
                ...
                >
                  ...
                  <div className="pt-4 border-t border-white/10 flex items-center justify-between mt-5">
                    ...
                    <span className="text-[9px] text-[#25D366] font-sans tracking-[0.15em] font-semibold flex items-center gap-1.5 group-hover:underline underline-offset-4">
                      WHATSAPP <WhatsAppIcon className="w-3.5 h-3.5" />
                    </span>
                  </div>
                </div>
              ))}
